...
##' @title Str Method for Objects of Class "gnn_GMMN"
##' @param object object of class "gnn_GMMN"
...
##' @title Summary Method for Objects of Class "gnn_GMMN"
##' @param object object of class "gnn_GMMN"
##' @return return value of the summary method for objects of class "list"
##' @author Marius Hofert
summary.gnn_GMMN <- function(object, ...)
{
